const Footer = () => {
    return (
        <div>
            <div className=" m-d-none mt-5 pt-5">
                ...
                >
                    ...
                    <div
                        ...
                        style={{ backgroundColor: 'rgba(0, 0, 0, 0)', borderTop:'2px solid white' }}
                    >
                     <div className="container">   © Aesop</div>
                    </div>
                    {/* <!-- Copyright --> */}
                </footer>
                {/* <!-- Footer --> */}
            ...
            <div className="d-d-none mt-5 pt-5">
